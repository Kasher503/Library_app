  ...
  return (
    <div className="grid items-center grid-cols-1 gap-6 px-2 justify-items-center lg:p-2 lg:px-12 md:grid-cols-3 lg:grid-cols-4 bg-DarkColor">
      {books.slice(0, 20).map((book, index) => (
        <div
          key={index}
          className="w-64 pt-5 border shadow-lg border-theme-dark-Blue h-80 card"
        >
          <figure>
          ...
          <div className="p-4">
            ...
            <div className="justify-end mt-5 card-actions ">
              <Button
                borderRadius="0.5rem"
                className="p-2 font-bold text-white border rounded-md border-theme-dark-Blue hover:bg-theme-dark-Blue bg-DarkColor"
                onClick={() => handleOpenModal(book)} // Pass the book variable as needed
              >
                Details
              </Button>
            </div>
